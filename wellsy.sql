...
CREATE TABLE HEALTH_RECORD (
    HEALTH_RECORD_ID INT NOT NULL primary key auto_increment,
...
CREATE TABLE EXERCISE_RECORD (
    EXERCISE_RECORD_ID INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    EMPLOYEE_NO INT NOT NULL,
...
CREATE TABLE SLEEP_RECORD (
    SLEEP_RECORD_ID INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    EMPLOYEE_NO INT NOT NULL,
...
CREATE TABLE MEAL_RECORD (
    MEAL_RECORD_ID INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    EMPLOYEE_NO INT NOT NULL,
...
CREATE TABLE CHECKUP_RESERVATION (
    ...
    RECENT_CHECKUP_DATE DATE         DEFAULT NULL,
    HOSPITAL_NAME       VARCHAR(100) DEFAULT NULL,
    STATUS              VARCHAR(20)  NOT NULL,
    MEMO                VARCHAR(500) DEFAULT NULL,
    CREATED_AT          TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT PK_CHECKUP_RESERVATION
        PRIMARY KEY (RESERVATION_ID),

    CONSTRAINT FK_CHECKUP_RESERVATION_EMPLOYEE
        FOREIGN KEY (EMPLOYEE_NO)
        REFERENCES EMPLOYEE (EMPLOYEE_NO),

    CONSTRAINT CK_CHECKUP_RESERVATION_STATUS
        CHECK (STATUS IN ('Y', 'N', 'C'))
...
CREATE TABLE HEALTH_CHECKUP (
    CHECKUP_ID INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
